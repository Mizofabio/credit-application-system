...
class CreditServiceTest {
    ...
    @BeforeEach
    fun setup() {
        MockKAnnotations.init(this)   //creditService = CreditService(creditRepository, customerService)
    }
    ...
    fun `should return credit for a valid customer and credit code`(){
        val customerId: Long = 1L   // criar um customer id 1
        val creditCode: UUID = UUID.randomUUID()   // criar creditCode randonico
    ...
    @Test
    fun `should throw BusinessException fora invalid credit code`(){
        val customerId: Long = 1L
    ...
    fun `should throw IllegalArgumentException for different customer ID`(){
        ...
        val credit: Credit = buildCredit(customer = Customer(id = 2L)) // recebe ID diferente
    ...
    companion object {
        private fun buildCredit(
            ...
            dayFirstInstallment: LocalDate = LocalDate.now().plusMonths(11L),
